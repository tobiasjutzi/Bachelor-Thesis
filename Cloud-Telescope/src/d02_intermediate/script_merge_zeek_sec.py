...
def scanner_zeek(path_udp_script: str, path_log_folder: str, path_zeek_config_disable_logs: str, path_pcap_file: str):
    ...
    while interval <= max_interval:
        ...
        # set interval
        addr_scan_interval: str = f'        const addr_scan_interval = {interval}secs &redef;'
        port_scan_interval: str = f'        const port_scan_interval = {interval}secs &redef;'
        try:
        ...
        while threshold <= max_threshold:
            ...
            folder_name: str = f'zeek_scan_addr-{threshold}_{interval}:60min_p-{threshold}_{interval}:60min'
